...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-xl text-gray-600"><?php echo e($quiz->title); ?></p>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-xl p-8 mb-8">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            <!-- Score -->
            <div class="bg-gradient-to-br <?php echo e($attempt->passed ? 'from-green-50 to-green-100' : 'from-orange-50 to-orange-100'); ?> rounded-lg p-6">
                <p class="text-sm font-semibold <?php echo e($attempt->passed ? 'text-green-700' : 'text-orange-700'); ?> uppercase tracking-wide mb-2">Your Score</p>
                <p class="text-5xl font-bold <?php echo e($attempt->passed ? 'text-green-600' : 'text-orange-600'); ?>"><?php echo e($attempt->percentage); ?>%</p>
                <p class="text-sm text-gray-600 mt-2"><?php echo e($attempt->score); ?> / <?php echo e($attempt->total_points); ?> points</p>
            </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6">
                ...
                ?>
                <p class="text-5xl font-bold text-blue-600"><?php echo e($correctCount); ?></p>
                <p class="text-sm text-gray-600 mt-2">out of <?php echo e($quiz->questions()->count()); ?> questions</p>
            </div>
        ...
        <div class="mt-8 text-center">
            ...
            <?php elseif($attempt->percentage >= 70): ?>
            ...
            <?php elseif($attempt->percentage >= $quiz->passing_score): ?>
    ...
    <div class="bg-white rounded-lg shadow-md p-8 mb-8">
        ...
        <div class="space-y-6">
            ...
            <div class="border rounded-lg p-6 <?php echo e($isCorrect ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'); ?>">
                <div class="flex items-start justify-between mb-3">
                    <h3 class="font-bold text-gray-800">Question <?php echo e($index + 1); ?></h3>
                    <div class="flex items-center gap-2">
                        <span class="text-sm text-gray-600"><?php echo e($question->points); ?> pts</span>
                        <?php if($isCorrect): ?>
                ...
                <div class="space-y-2">
                    <div>
                        ...
                        <p class="text-gray-800">
                            <?php if($question->question_type === 'multiple_choice'): ?>
                                <?php echo e($question->options[$studentAnswer] ?? 'No answer'); ?>

                            <?php else: ?>
                                <?php echo e($studentAnswer ?? 'No answer'); ?>
                    ...
                    <div class="pt-2 border-t">
                        ...
                        <p class="text-green-800 font-semibold">
                            <?php if($question->question_type === 'multiple_choice'): ?>
                                <?php echo e($question->options[$question->correct_answer]); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/quizzes/result.blade.php ENDPATH**/ ?>