...
<?php $__env->startSection('title', 'Create Game'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8">
        <div class="flex items-center mb-4">
            <a href="<?php echo e(route('games.index')); ?>" class="text-indigo-600 hover:text-indigo-800 mr-4">
    ...
    <div class="bg-white rounded-lg shadow-md p-8 max-w-4xl">
        <form action="<?php echo e(route('games.store')); ?>" method="POST" id="gameForm">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['title'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" 
                              id="description" 
                              rows="3"
                              class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['description'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    ...
                    <select name="game_type" 
                            id="game_type" 
                            class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent <?php $__errorArgs = ['game_type'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <option value="flashcard" <?php echo e(old('game_type') == 'flashcard' ? 'selected' : ''); ?>>
                            Flashcards - Learn with front/back cards
                        </option>
                        <option value="matching" <?php echo e(old('game_type') == 'matching' ? 'selected' : ''); ?>>
                            Matching - Match terms with definitions
                        </option>
                        <option value="gamified_quiz" <?php echo e(old('game_type') == 'gamified_quiz' ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/games/create.blade.php ENDPATH**/ ?>