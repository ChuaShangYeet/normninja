...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-blue-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($stats['total_students'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-green-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($stats['total_quizzes'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-purple-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($stats['total_games'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-orange-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($stats['total_materials'] ?? 0); ?></p>
                </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border-t-4 border-pink-500">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-800 mt-2"><?php echo e($stats['total_forums'] ?? 0); ?></p>
                </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <?php if(isset($recentQuizAttempts) && $recentQuizAttempts->count() > 0): ?>
                <div class="space-y-3 max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $recentQuizAttempts->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg p-3 hover:bg-gray-50 transition">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <h3 class="font-semibold text-gray-800 text-sm"><?php echo e($attempt->student->name); ?></h3>
                                <p class="text-xs text-gray-500 mt-1"><?php echo e($attempt->quiz->title ?? 'Quiz Deleted'); ?></p>
                                <p class="text-xs text-gray-400 mt-1">
                                    <i class="fas fa-clock mr-1"></i><?php echo e($attempt->completed_at ? $attempt->completed_at->diffForHumans() : 'In Progress'); ?>

                                </p>
                            </div>
                            <div class="text-right">
                                <div class="text-xl font-bold <?php echo e($attempt->passed ? 'text-green-600' : 'text-red-600'); ?>">
                ...
                <a href="<?php echo e(route('teacher.student-performance')); ?>" class="block text-center mt-4 text-teal-600 hover:text-teal-800 text-sm font-semibold">
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <?php if(isset($recentGameAttempts) && $recentGameAttempts->count() > 0): ?>
                <div class="space-y-3 max-h-96 overflow-y-auto">
                    <?php $__currentLoopData = $recentGameAttempts->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="border rounded-lg p-3 hover:bg-gray-50 transition">
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <h3 class="font-semibold text-gray-800 text-sm"><?php echo e($attempt->student->name); ?></h3>
                                <p class="text-xs text-gray-500 mt-1"><?php echo e($attempt->game->title); ?></p>
                                <p class="text-xs text-gray-400 mt-1">
                                    <i class="fas fa-clock mr-1"></i><?php echo e(gmdate('i:s', $attempt->time_spent_seconds)); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Create Quiz -->
        <a href="<?php echo e(route('quizzes.create')); ?>" class="bg-green-500 hover:bg-green-600 rounded-lg shadow-md p-6 text-white transition transform hover:scale-105">
            <div class="flex items-center justify-between">
                <div>
        ...
        <!-- Create Game -->
        <a href="<?php echo e(route('games.create')); ?>" class="bg-purple-500 hover:bg-purple-600 rounded-lg shadow-md p-6 text-white transition transform hover:scale-105">
            <div class="flex items-center justify-between">
                <div>
        ...
        <!-- Upload Material -->
        <a href="<?php echo e(route('learning-materials.create')); ?>" class="bg-orange-500 hover:bg-orange-600 rounded-lg shadow-md p-6 text-white transition transform hover:scale-105">
            <div class="flex items-center justify-between">
                <div>
        ...
        <!-- View Performance -->
        <a href="<?php echo e(route('teacher.student-performance')); ?>" class="bg-blue-500 hover:bg-blue-600 rounded-lg shadow-md p-6 text-white transition transform hover:scale-105">
            <div class="flex items-center justify-between">
                <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/teacher/dashboard.blade.php ENDPATH**/ ?>