<?php $__env->startSection('title', 'Play: ' . $game->title); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-gray-800"><?php echo e($game->title); ?></h1>
                <p class="text-gray-600"><?php echo e($game->subject); ?></p>
            </div>
    ...
    <div id="flashcard-game" class="max-w-2xl mx-auto">
        <div class="mb-6 flex justify-between items-center">
            <div>
                <span class="text-lg font-semibold text-gray-700">
                    Card <span id="current-card">1</span> of <span id="total-cards"><?php echo e(count($game->game_data['flashcards'])); ?></span>
                </span>
            </div>
            <div>
        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                ...
                <div class="progress-dot w-3 h-3 rounded-full bg-gray-300" data-index="<?php echo e($index); ?>"></div>
    ...
    <script>
    const flashcards = <?php echo json_encode($game->game_data['flashcards'], 15, 512) ?>;
        ...
        <div class="grid grid-cols-2 gap-6">
            ...
            <div class="space-y-3">
                ...
                <div class="matching-item term bg-blue-100 border-2 border-blue-300 p-4 rounded-lg cursor-pointer hover:bg-blue-200 transition"
                     ...
                     onclick="selectTerm(<?php echo e($index); ?>)">
                    <p class="font-semibold text-gray-800"><?php echo e($pair['term']); ?></p>
                </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
            ...
            <div class="space-y-3">
                ...
                ?>
                <?php $__currentLoopData = $shuffled; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $pair): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="matching-item definition bg-green-100 border-2 border-green-300 p-4 rounded-lg cursor-pointer hover:bg-green-200 transition"
                     data-index="<?php echo e(array_search($pair, $game->game_data['pairs'])); ?>"
                     onclick="selectDefinition(<?php echo e(array_search($pair, $game->game_data['pairs'])); ?>)">
    ...
    let matchScore = 0;
    let totalPairs = <?php echo e(count($game->game_data['pairs'])); ?>;
    let matchedPairs = 0;
    ...
    <div id="quiz-game" class="max-w-3xl mx-auto">
        <div class="mb-6 flex justify-between items-center">
            <div>
                <span class="text-lg font-semibold text-gray-700">
                    Question <span id="current-question">1</span> of <span id="total-questions"><?php echo e(count($game->game_data['questions'])); ?></span>
                </span>
            </div>
    ...
    <script>
    const questions = <?php echo json_encode($game->game_data['questions'], 15, 512) ?>;
    ...
    <form id="submit-form" action="<?php echo e(route('games.submit', $game)); ?>" method="POST" style="display: none;">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/games/play.blade.php ENDPATH**/ ?>