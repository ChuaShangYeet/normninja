...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $quiz->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="passing_score" 
                           id="passing_score" 
                           value="<?php echo e(old('passing_score', $quiz->passing_score)); ?>"
                           min="0"
                           max="100"
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" 
                           name="is_published" 
                           value="1" 
                           <?php echo e(old('is_published', $quiz->is_published) ? 'checked' : ''); ?>
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($quiz->questions()->count()); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Total Points</p>
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($quiz->total_points); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Attempts</p>
                        <p class="text-2xl font-bold text-gray-800"><?php echo e($quiz->attempts()->count()); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Completed</p>
                        <p class="text-2xl font-bold text-green-600"><?php echo e($quiz->attempts()->where('is_completed', true)->count()); ?></p>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/quizzes/edit.blade.php ENDPATH**/ ?>