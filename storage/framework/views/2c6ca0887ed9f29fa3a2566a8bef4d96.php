<?php $__env->startSection('title', 'Game Results'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-xl text-gray-600"><?php echo e($game->title); ?></p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-xl p-8 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                ...
                <div class="bg-gradient-to-br from-green-50 to-green-100 rounded-lg p-6">
                    ...
                    <p class="text-5xl font-bold text-green-600"><?php echo e($attempt->score); ?></p>
                    <?php if($game->game_type === 'gamified_quiz'): ?>
                    <p class="text-sm text-gray-600 mt-2">
                        out of <?php echo e(collect($game->game_data['questions'])->sum('points')); ?> possible
                    </p>
                    <?php endif; ?>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6">
                    ...
                    <p class="text-5xl font-bold text-blue-600"><?php echo e($attempt->formatted_time); ?></p>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php $__currentLoopData = $allAttempts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $historyAttempt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="<?php echo e($historyAttempt->id === $attempt->id ? 'bg-indigo-50' : 'hover:bg-gray-50'); ?>">
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    <?php if($historyAttempt->id === $attempt->id): ?>
                                    <span class="bg-indigo-600 text-white text-xs px-2 py-1 rounded mr-2">Current</span>
                                    <?php endif; ?>
                                    <span class="text-sm font-medium text-gray-900">
                                        Attempt #<?php echo e($allAttempts->count() - $index); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    <?php echo e($historyAttempt->created_at->format('M d, Y')); ?>

                                </div>
                                <div class="text-xs text-gray-500">
                                    <?php echo e($historyAttempt->created_at->format('h:i A')); ?>

                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($historyAttempt->is_completed): ?>
                                <div class="text-lg font-bold text-gray-900">
                                    <?php echo e($historyAttempt->score); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <?php if($historyAttempt->is_completed): ?>
                                <div class="text-sm text-gray-900">
                                    <?php echo e($historyAttempt->formatted_time); ?>
            ...
            <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg p-4 border-l-4 border-yellow-400">
                    ...
                    <p class="text-3xl font-bold text-yellow-600"><?php echo e($bestScore); ?></p>
                </div>
                <?php if($bestTime !== null): ?>
                <div class="bg-gradient-to-r from-blue-50 to-blue-100 rounded-lg p-4 border-l-4 border-blue-400">
                    ...
                    <p class="text-3xl font-bold text-blue-600">
                        <?php echo e(sprintf('%d:%02d', floor($bestTime / 60), $bestTime % 60)); ?>
        ...
        <?php if($allAttempts->where('is_completed', true)->count() > 1): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/games/results.blade.php ENDPATH**/ ?>