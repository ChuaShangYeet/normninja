...
<div class="space-y-6">
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center">
                <a href="<?php echo e(route('admin.teachers.index')); ?>" class="mr-4 text-gray-600 hover:text-gray-900">
            ...
            <div class="flex items-center space-x-2">
                <div class="flex-shrink-0 h-12 w-12">
                    <?php if($teacher->profile_picture): ?>
                        <img class="h-12 w-12 rounded-full object-cover border-2 border-gray-200" src="<?php echo e(Storage::url($teacher->profile_picture)); ?>" alt="<?php echo e($teacher->name); ?>">
                    <?php else: ?>
                ...
                <div>
                    <p class="text-sm font-medium text-gray-900"><?php echo e($teacher->name); ?></p>
                    <p class="text-xs text-gray-500"><?php echo e($teacher->teacher_id); ?></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <form action="<?php echo e(route('admin.teachers.update', $teacher)); ?>" method="POST" enctype="multipart/form-data">
            ...
            <?php echo $__env->make('admin.teachers.form', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </form>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="bg-gray-50 p-4 rounded-lg">
                ...
                <p class="text-gray-900 font-medium"><?php echo e($teacher->created_at->format('F d, Y')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e($teacher->created_at->diffForHumans()); ?></p>
            </div>
            <div class="bg-gray-50 p-4 rounded-lg">
                <p class="text-sm text-gray-600 mb-1">Last Updated</p>
                <p class="text-gray-900 font-medium"><?php echo e($teacher->updated_at->format('F d, Y')); ?></p>
                <p class="text-xs text-gray-500"><?php echo e($teacher->updated_at->diffForHumans()); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 border-2 border-red-200">
        ...
        <form action="<?php echo e(route('admin.teachers.delete', $teacher)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this teacher? This action cannot be undone.');">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/admin/teachers/edit.blade.php ENDPATH**/ ?>