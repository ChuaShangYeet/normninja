...
<?php $__env->startSection('title', 'Edit Learning Material'); ?>
...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-lg shadow-md p-8 max-w-3xl">
        <form action="<?php echo e(route('learning-materials.update', $learningMaterial)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
            ...
            <div class="mb-6">
                ...
                <input type="text" 
                       name="title" 
                       id="title" 
                       value="<?php echo e(old('title', $learningMaterial->title)); ?>"
...
unset($__errorArgs, $__bag); ?>"><?php echo e(old('description', $learningMaterial->description)); ?></textarea>
            ...
            <div class="mb-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 border">
                    <div class="flex items-center">
                        <i class="fas fa-file-<?php echo e($learningMaterial->file_type === 'pdf' ? 'pdf' : ($learningMaterial->file_type === 'doc' || $learningMaterial->file_type === 'docx' ? 'word' : ($learningMaterial->file_type === 'ppt' || $learningMaterial->file_type === 'pptx' ? 'powerpoint' : 'video'))); ?> text-3xl text-purple-600 mr-4"></i>
                        <div>
                            <p class="font-semibold text-gray-800"><?php echo e(basename($learningMaterial->file_path)); ?></p>
                            <p class="text-sm text-gray-500">Type: <?php echo e(strtoupper($learningMaterial->file_type)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           name="subject" 
                           id="subject" 
                           value="<?php echo e(old('subject', $learningMaterial->subject)); ?>"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" 
                           name="grade_level" 
                           id="grade_level" 
                           value="<?php echo e(old('grade_level', $learningMaterial->grade_level)); ?>"
                           min="1"
                           max="12"
                           class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
            ...
            <div class="mb-6">
                <label class="flex items-center">
                    <input type="checkbox" 
                           name="is_published" 
                           value="1" 
                           <?php echo e(old('is_published', $learningMaterial->is_published) ? 'checked' : ''); ?>
            ...
            <div class="bg-gray-50 rounded-lg p-6 mb-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-800"><?php echo e($learningMaterial->created_at->format('M d, Y')); ?></p>
                    </div>
                    <div>
                        <p class="text-sm text-gray-600">Last Updated</p>
                        <p class="text-lg font-semibold text-gray-800"><?php echo e($learningMaterial->updated_at->format('M d, Y')); ?></p>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\normninja\resources\views/learning-materials/edit.blade.php ENDPATH**/ ?>